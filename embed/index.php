...
<style>
  ...
  section#map-section div#map-event-list form#zip-and-distance input[name=zipcode] { font-size: 1.2em !important; }
   ...
   section#map-section, div#map { height: 450px !important; }
</style>
...
<section id='main-title-area'>
  <h4><strong><span id="meetup-counter"><img src='../img/icon/ajax-loader.gif'> Loading</span> Bernie Sanders Events &amp; Meetups.</strong> <span>Discover upcoming events or</span> <a href="http://goo.gl/forms/1dCkCj4zi9" target="_blank">Submit&nbsp;your&nbsp;group&apos;s&nbsp;meetup</a>
    <?php  /*
    <div id="social">
