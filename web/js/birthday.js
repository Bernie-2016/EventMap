...
bernMap.draw = function() {
  ...
  this.mapOffices = function() {
    ...
    if (!that.mainOffices) {
      that.mainOffices = that.activityLayer.selectAll("image.bernie-main-office")
      ...
      that.mainOffices =
          that.activityLayer.selectAll("image.bernie-main-office")
              .each(function(d) {
                var coordinates = that._projectPoint(d.lon, d.lat);
                  d3.select(this).attr("x", coordinates[0] - 7)
                      .attr("y", coordinates[1] - 7)
  ...
  this.plot = function () {
    ...
    that.activityLayer.selectAll("image.work-item").remove();

    that.zipcodeElements = that.activityLayer.selectAll("image.work-item")
                              .data(bernMap.d.zipcodes.features).enter()
                              .append("image")
                                .attr("xlink:href", function(d) {
                                switch (d.properties.type) {
                                  case "CW" : return "/img/birthday/bday-2.png"; break;
                                  case "E" : return "/img/birthday/bday-1.png"; break;
                                  case "R" : return "/img/birthday/bday-3.png"; break;
                                }
                              })
                                .attr("width", "16px")
                                .attr("height", "16px")
                              ...
                              .attr("class", function(d) {
                                switch (d.properties.type) {
                                  case "CW" : return "work-item campaign-work"; break;
                                  case "E" : return "work-item grassroots-event"; break;
                                  case "R" : return "work-item official-rally"; break;
                                }
                              })
                              ...
                              .each(function(d) {
                                var coordinates = that._projectPoint(d.geometry.coordinates[0], d.geometry.coordinates[1]);
                                  d3.select(this).attr("x", coordinates[0]-8)
                                      .attr("y", coordinates[1]-8)
                                  ;
                              }).call(function () {
...
bernMap.eventList = function(container) {
  ...
  this.buildEvent = function(d) {
     ...
     switch (d.properties.type) {
      case "CW": eventType = 'campaign-work'; eventText = "<img src='/img/birthday/bday-2.png' style='width: 20px; height: 20px; vertical-align: middle;'/> Volunteer Activity"; break;
      case "E" : eventType = 'meetup'; eventText = "<img src='/img/birthday/bday-1.png' style='width: 20px; height: 20px; vertical-align: middle;'/> Meeting"; break;
      case "R" : eventType = 'rally'; eventText = "<img src='/img/birthday/bday-3.png' style='width: 20px; height: 20px; vertical-align: middle;'/> Official Event"; break;
     }
