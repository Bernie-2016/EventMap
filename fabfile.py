...
def deploy_event_data():
    ...
    print src.substitute({'invalidation_id': invalidation_id})
    ...
    local('curl -H "Content-Type: text/xml" -H "Authorization: %s" http://cloudfront.amazonaws.com/distribution/E2SIHVDQUPIR5Z/invalidation')
